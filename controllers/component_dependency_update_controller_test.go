...
var _ = Describe("Component nudge controller", func() {
	...
	Context("Test build nudges component", func() {
		...
		It("Test build performs nudge on success, only component renovate config provided", func() {
			...
			component1.Annotations[CustomRenovateConfigMapAnnotation] = customConfigName
			...
			component2.Annotations[CustomRenovateConfigMapAnnotation] = customConfigName
		...
		It("Test build performs nudge on success, namespace wide and component renovate config provided", func() {
			...
			createCustomRenovateConfigMap(customConfigMapName, customConfigMapData)
			customNamespaceConfigMapName := types.NamespacedName{Namespace: UserNamespace, Name: NamespaceWideRenovateConfigName}
			...
			createCustomRenovateConfigMap(customNamespaceConfigMapName, customNamespaceConfigMapData)
