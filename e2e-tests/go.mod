...
require (
	...
	github.com/codeready-toolchain/api v0.0.0-20260709092545-4fb0bb97aa86 // indirect
	github.com/codeready-toolchain/toolchain-common v0.0.0-20260716150519-6482f1e106c2 // indirect
