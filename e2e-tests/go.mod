...
require (
	...
	github.com/konflux-ci/image-controller v0.0.0-20260902123452-65b644b9b875 // indirect
	github.com/konflux-ci/integration-service v0.0.0-20260908121035-278281fdf582 // indirect
