...
require (
	...
	github.com/codeready-toolchain/toolchain-e2e v0.0.0-20260922083546-f66c19287eb1 // indirect
	...
	github.com/konflux-ci/image-controller v0.0.0-20260922140956-1775f73cc0f9 // indirect
