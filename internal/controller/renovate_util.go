...
func (u ComponentDependenciesUpdater) CreateRenovaterPipeline(ctx context.Context, nudgingPipelineRun *tektonapi.PipelineRun, targets []updateTarget, debug bool, buildResult *BuildResult, gitRepoAtShaLink string) error {
	log := logger.FromContext(ctx)
